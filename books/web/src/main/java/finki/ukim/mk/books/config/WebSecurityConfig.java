package finki.ukim.mk.books.config;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public WebSecurityConfig(PasswordEncoder passwordEncoder, CustomUsernamePasswordProvider customUsernamePasswordProvider) {
