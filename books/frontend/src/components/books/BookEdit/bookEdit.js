...
const BookEdit = (props) => {
    ...
    const onFormSubmit = (e) => {
        ...
        const avaliableCopies = formData.avaliableCopies !== 0 ? formData.avaliableCopies : props.product.avaliableCopies;
        ...
        props.onEditBook(props.book.id, name, author,category,avaliableCopies);
        history.push("/books");
    }
        ...
        <div className="row mt-5">
            <div className="col-md-5">
                <form onSubmit={onFormSubmit}>
                    ...
                    <div className="form-group">
                        <label htmlFor="quantity">avaliableCopies</label>
                        <input type="text"
                               className="form-control"
                               id="avaliableCopies"
                               name="avaliableCopies"
                               placeholder={props.book.avaliableCopies}
                               onChange={handleChange}
                        />
                    </div>
